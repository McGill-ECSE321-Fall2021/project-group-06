...
public class OpeningHourController {
    ...
    public OpeningHourDto createOpeningHour(@RequestParam int id, @RequestParam Date date, @RequestParam Time startTime, @RequestParam Time endTime) throws Exception{
        // OpeningHour openingHour = null;
        try{
            OpeningHour openingHour= service.createOpeningHour(id, date, startTime, endTime);
