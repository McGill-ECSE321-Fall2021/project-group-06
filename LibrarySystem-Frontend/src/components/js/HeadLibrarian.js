...
export default {
    ...
    methods: {
      ...
      createShift: function(shiftID, dayOfWeek, startTime, endTime){
        ...
        .catch(e => {
          swal("Error", "Error Creating Shift", "error")
          this.errorShift = e
        })
      },
      updateShift: function(shiftID, dayOfWeek, startTime, endTime){
        ...
        .catch(e => {
          swal("Error", "Error Updating Shift", "error")
      ...
      deleteShift: function (id){
        ...
        .then(response => {
          ...
          .catch(e => {
            swal("Error", "Error Deleting Shift", "error")
            this.librarianError = e
          })
      },
      assignShift: function (shiftID, libID){
        ...
        .then(response => {
          ...
          .catch(e => {
            swal("Error", "Error Assigning Shift", "error")
            this.librarianError = e
          })
      },
      ...
      updateOH: function (ohID, dayOfWeek, startTime, endTime) {
        ...
        .catch(e => {
          swal("Error", "Error Updating Opening Hour", "error")
          this.librarianError = e
        })
      },
      unAssignShift: function (id, shiftID) {
        ...
        .catch(e => {
          swal("Error", "Error Unassigning Shift", "error")
          this.librarianError = e
        })
      },
      deleteOpeningHour: function (id){
        ...
        .then(response => {
          ...
          .catch(e => {
            swal("Error", "Error Deleting Opening Hour", "error")
            this.librarianError = e
          })
      },
      hireLibrarian: function(libID, password){
        ...
        .catch(e => {
          swal("Error", "Error Hiring Librarian", "error")
          this.errorShift = e
        })
      },
      fireLibrarian: function (id){
        ...
        .then(response => {
          ...
          .catch(e => {
            swal("Error", "Error Firing Librarian", "error")
            this.librarianError = e
          })
      },
      //media, coi
      createCOI: function(mediaID, mediaType, name, borrowingPeriod, date){
        ...
        .catch(e => {
          swal("Error", "Error Creating Check Out Item", "error")
          this.errorShift = e
        })
      },
      updateCOI: function(mediaID, mediaType, name, checkedOut, reserved, borrowingPeriod, date){
        ...
        .catch(e => {
          swal("Error", "Error Updating Check Out Item", "error")
          this.librarianError = e
        })
      },
      deleteCOI: function (id){
        ...
        .then(response => {
          ...
          .catch(e => {
            swal("Error", "Error Deleting Check Out Item", "error")
            this.librarianError = e
          })
      },
      //NCOI
      createNCOI: function(mediaID, mediaType, name){
        ...
        .catch(e => {
          swal("Error", "Error Creating Non Check Out Item", "error")
          this.errorShift = e
        })
      },
      updateNCOI: function(mediaID, mediaType, name){
        ...
        .catch(e => {
          swal("Error", "Error Updating Non Check Out Item", "error")
          this.librarianError = e
        })
      },
      deleteNCOI: function (id){
        ...
        .then(response => {
          ...
          .catch(e => {
            swal("Error", "Error Deleting Non Check Out Item", "error")
            this.librarianError = e
          })
      }
