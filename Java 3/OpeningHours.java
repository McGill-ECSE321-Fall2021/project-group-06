...
public class OpeningHours
{
  ...
  public OpeningHours(Date aDate, Time aStartTime, Time aEndTime, int aIdForHeadLibrarian, String aAddressForHeadLibrarian, String aNameForHeadLibrarian, AccountType aAccountTypeForHeadLibrarian, boolean aIsLocalForHeadLibrarian, int aNumCheckedForHeadLibrarian, LibrarySystem aLibrarySystemForHeadLibrarian, Time aStartShiftForHeadLibrarian, Time aEndShiftForHeadLibrarian)
  {
    date = aDate;
    startTime = aStartTime;
    endTime = aEndTime;
    ...
    headLibrarian = new HeadLibrarian(aIdForHeadLibrarian, aAddressForHeadLibrarian, aNameForHeadLibrarian, aAccountTypeForHeadLibrarian, aIsLocalForHeadLibrarian, aNumCheckedForHeadLibrarian, aLibrarySystemForHeadLibrarian, aStartShiftForHeadLibrarian, aEndShiftForHeadLibrarian, this);
  }
